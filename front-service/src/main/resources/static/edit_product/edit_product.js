angular.module('store').controller('editProductController', function ($scope, $http, $routeParams, $location, $localStorage) {
    ...
    $scope.prepareProductForUpdate = function () {
        $http.get($localStorage.contextPath + 'core/api/v1/products/' + $routeParams.productId)
    ...
    $scope.updateProduct = function () {
        $http.put($localStorage.contextPath + 'core/api/v1/products', $scope.updated_product)
            .then(function successCallback (response) {
