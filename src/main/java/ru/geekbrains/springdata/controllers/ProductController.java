...
import ru.geekbrains.springdata.repositories.specifications.ProductSpecs;
...
public class ProductController {
    ...
    public Page<ProductDto> findAllWithFilters(
        ...
        return productService.getProductsWithPagingAndFiltering(currentPage, currentPageSize, spec).map(ProductDto::new);
    }
